package com.bpc.introtocompose
...
import com.bpc.introtocompose.ui.theme.IntroToComposeTheme
...
fun MyApp(innerPadding: PaddingValues = PaddingValues(0.dp)) {
    ...
    Surface (modifier = Modifier
        ...
        Column(
            ...
            Text(text = "R$ ${moneyCounter.value}", style = TextStyle(
                color = Color.White,
                fontSize = 39.sp,
